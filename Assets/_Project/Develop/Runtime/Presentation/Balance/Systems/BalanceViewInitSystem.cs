...
{
    public sealed class BalanceViewInitSystem : IEcsRunSystem
    {
        private readonly EcsFilter<Balance, ViewInitRequest> _balanceFilter;

        private readonly BalanceView _balanceView;

        public BalanceViewInitSystem(BalanceView balanceView)
        {
